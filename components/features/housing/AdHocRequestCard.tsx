...
export default function AdHocRequestCard({
  ...
  if (variant === "horizontal") {
    return (
      <>
        <div className="relative bg-gradient-to-br from-fiji-gold to-amber-600 text-white border border-amber-500/30 rounded-xl p-4 flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 shadow-sm hover:shadow-md transition-all group h-full overflow-hidden">
          {/* Background Flair */}
          ...
          <div className="flex items-center gap-4 flex-1">
            ...
            <div className="flex-1 min-w-0 flex flex-col justify-center relative z-10">
              ...
              <p className="text-amber-50/70 text-xs line-clamp-1">
                Cleaned up a mess? Fixed something? Submit a photo and get
                points!
              </p>
            </div>
          </div>
          ...
          {/* ACTION */}
          <div className="shrink-0 w-full sm:w-[140px] relative z-10">
            <button
