...
- [x] Task: Update the codebase to handle removed or renamed variables (e.g., removing 'dev role' usages, ensuring 'DISCORD*ROLE_ID*' prefixes are respected) 9cba895
