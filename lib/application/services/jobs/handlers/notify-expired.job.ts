      ...
      for (const task of tasksToNotify) {
        try {
          ...
          if (afterChannel.notification_level === "expired") {
            metrics.skipAlreadyFullyNotified++;
            console.log("[NotifyExpiredJob]", {
