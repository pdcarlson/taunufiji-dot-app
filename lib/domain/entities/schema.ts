 ...
 *
 * Contains all collection names, database ID, and TypeScript interfaces
 * for Appwrite document schemas.
 */
...
export interface ScheduleSchema {
  ...
  lead_time_hours?: number; // Hours before due date to spawn task
}
